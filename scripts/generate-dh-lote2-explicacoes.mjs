...
const codeContent = `// Explicações pedagógicas do Lote 2 de Direitos Humanos e Cidadania (50 questões)
...
fs.writeFileSync('scripts/dh-lote2-explicacoes.mjs', codeContent, 'utf8');
console.log('Arquivo scripts/dh-lote2-explicacoes.mjs gerado com sucesso! Total:', explicacoes.length);
