#!/usr/bin/env node
// Gera supabase/aplicar_portugues_lote3_teste_rollback.sql
// a partir de scripts/portugues-lote3-explicacoes.mjs.
...
const OUT_PATH = 'supabase/aplicar_portugues_lote3_teste_rollback.sql';
...
begin
  ...
  select 'os ids afetados sao exatamente os 50 esperados',
    (select array_agg(id order by id) from _lp3_ids_afetados) = ${idsLiteralArray};
