// SUB-LOTE 4 — Explicações pedagógicas completas para 31 questões de Lei
// Maria da Penha JÁ EXISTENTES no banco, classificadas como
// EXPLICACAO_INCOMPLETA (tinham texto boilerplate do tipo "Gabarito
// indicado no Caderno TEC..." — nenhuma tinha qualquer marcador
// estrutural). Escritas do zero, mesmo padrão do Lote 1.
//
// Reconciliação de escopo (Fase 1, auditoria já aprovada pelo usuário):
// conjunto original de 32 EXPLICACAO_INCOMPLETA, id 738 excluído
// (PROBLEMATICA/FUNDAMENTO INCERTO — gabarito atribui a delegado de
// polícia poder de afastamento cautelar em violência contra
// criança/adolescente; art. 130 do ECA, mesmo após a Lei 15.240/2025,
// reserva essa medida à autoridade judiciária; sem base legal confirmada
// para a competência do delegado nesse contexto específico). Restam 31.
//
...
// já usada no Lote 1 e no hotfix das emendas 2024-2026.
//
// Ressalvas obrigatórias aplicadas (instrução do usuário):
//   - id 51 e id 866: o enunciado/alternativa reproduz a redação ANTIGA
//     do critério de risco do art. 12-C ("física ou psicológica"); a
//     redação vigente (Lei 15.411/2026) ampliou para física, sexual,
//     psicológica, moral ou patrimonial. Gabarito não muda em nenhum dos
//     dois casos.
//   - id 780: a alternativa usa "erradicar", mas a redação literal do
//     art. 1º é "coibir e prevenir" — mesmo assim, é a melhor alternativa
//     entre as 5 oferecidas.
//   - id 800: a alternativa correta (Delegacia de Atendimento à Mulher)
//     não corresponde a nenhuma "conduta imediata" literal dos arts.
//     10-12 — o fundamento é institucional (arts. 8º, IV e 12-A).
//
// Pares idênticos (mesmo enunciado e alternativas, fontes diferentes) —
// reaproveitada a MESMA string de explicação nos dois membros de cada
// par, via variável compartilhada, para garantir identidade byte a byte:
//   129 / 864 — diretrizes de inquirição do art. 10-A, §1º
//   133 / 865 — prazo de 48 horas do art. 18
//   134 / 863 — art. 9º, §2º (pegadinha dos "3 meses" vs. 6 meses)

const explicacao129 = `GABARITO: alternativa D
...
const explicacao133 = `GABARITO: alternativa E
...
const explicacao134 = `GABARITO: alternativa C
...
{ id: 21, explicacao: `GABARITO: alternativa A
...
{ id: 40, explicacao: `GABARITO: alternativa D
...
{ id: 51, explicacao: `GABARITO: alternativa E
...
{ id: 129, explicacao: explicacao129 },

{ id: 133, explicacao: explicacao133 },

{ id: 134, explicacao: explicacao134 },

{ id: 344, explicacao: `GABARITO: alternativa C
...
{ id: 345, explicacao: `GABARITO: alternativa E
...
{ id: 346, explicacao: `GABARITO: alternativa E
...
{ id: 347, explicacao: `GABARITO: alternativa A
...
{ id: 671, explicacao: `GABARITO: alternativa C
...
{ id: 672, explicacao: `GABARITO: alternativa E
...
{ id: 673, explicacao: `GABARITO: alternativa D
...
{ id: 734, explicacao: `GABARITO: alternativa B
...
{ id: 735, explicacao: `GABARITO: alternativa A
...
{ id: 736, explicacao: `GABARITO: alternativa B
...
{ id: 737, explicacao: `GABARITO: alternativa C
...
{ id: 739, explicacao: `GABARITO: alternativa C
...
{ id: 778, explicacao: `GABARITO: alternativa D
...
{ id: 779, explicacao: `GABARITO: alternativa D
...
{ id: 780, explicacao: `GABARITO: alternativa B
...
{ id: 799, explicacao: `GABARITO: alternativa D
...
{ id: 800, explicacao: `GABARITO: alternativa B
...
{ id: 801, explicacao: `GABARITO: alternativa D
...
{ id: 802, explicacao: `GABARITO: alternativa B
...
{ id: 861, explicacao: `GABARITO: alternativa E
...
{ id: 862, explicacao: `GABARITO: alternativa C
...
{ id: 863, explicacao: explicacao134 },

{ id: 864, explicacao: explicacao129 },

{ id: 865, explicacao: explicacao133 },

{ id: 866, explicacao: `GABARITO: alternativa C
