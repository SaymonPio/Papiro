#!/usr/bin/env node
// Mesma validação de duas camadas do sub-lote 1 (ver
// scripts/validar-sublote1-explicacoes.mjs), aplicada ao sub-lote 2.

import fs from 'fs';
import { explicacoes } from './sublote2-lei-maria-penha-explicacoes.mjs';

const RAW_PATH = 'C:/Users/User/AppData/Local/Temp/claude/C--Users-User-Desktop-Papiro-corrigido-Papiro-com/05fe1ce8-5b6b-4a87-bae9-e09d32a28036/scratchpad/lote1_sublote2_raw.json';
