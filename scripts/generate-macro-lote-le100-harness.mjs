#!/usr/bin/env node
// Gera supabase/aplicar_macro_lote_le100_teste_rollback.sql
// a partir de scripts/macro-lote-le100-explicacoes.mjs.

import fs from 'fs';
import { explicacoes } from './macro-lote-le100-explicacoes.mjs';

const OUT_PATH = 'supabase/aplicar_macro_lote_le100_teste_rollback.sql';
