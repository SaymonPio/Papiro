#!/usr/bin/env node
// Gera supabase/aplicar_informatica_lote1_teste_rollback.sql
// a partir de scripts/informatica-lote1-explicacoes.mjs.
...
const OUT_PATH = 'supabase/aplicar_informatica_lote1_teste_rollback.sql';
...
begin
  ...
  select 'os ids afetados sao exatamente os 50 esperados',
    (select array_agg(id order by id) from _inf1_ids_afetados) = ${idsLiteralArray};
