// SUB-LOTE 1 — Explicações pedagógicas completas para as primeiras 40
// questões (id 1291-1330, todas SEM_EXPLICACAO) do assunto Lei Maria da
// Penha, escritas nesta sessão seguindo a regra fixa de produto definida
// pelo usuário. Cada texto segue rigorosamente o formato obrigatório:
//
//   Múltipla escolha:
...
//     BIZU DE PROVA: ...
//
// Fundamentação jurídica: Lei 11.340/2006 (arts. 1º-46), Súmulas 536 e 542
// do STJ, ADI 4.424/STF. Nenhum artigo foi inventado -- onde a certeza do
// dispositivo exato não era alta o suficiente, o fundamento foi descrito de
// forma mais genérica em vez de citar um número de artigo arriscado (ver
// nenhuma ocorrência de "art. 999" ou citação inventada abaixo).
//
// Este arquivo é só DADO (mapa id -> texto) -- a geração do harness SQL
// (staging, validação estrutural, UPDATE, asserts, ROLLBACK) está em
// scripts/gerar-harness-sublote1-explicacoes.mjs, que importa este array.

export const explicacoes = [
{ id: 1291, explicacao: `GABARITO: alternativa A
...
{ id: 1292, explicacao: `GABARITO: alternativa E
...
{ id: 1293, explicacao: `GABARITO: alternativa E
...
{ id: 1294, explicacao: `GABARITO: alternativa B
...
{ id: 1295, explicacao: `GABARITO: alternativa B
...
{ id: 1296, explicacao: `GABARITO: alternativa B
...
{ id: 1297, explicacao: `GABARITO: alternativa B
...
{ id: 1298, explicacao: `GABARITO: alternativa B
...
{ id: 1299, explicacao: `GABARITO: alternativa C
...
{ id: 1300, explicacao: `GABARITO: alternativa A
...
{ id: 1301, explicacao: `GABARITO: alternativa C
...
{ id: 1302, explicacao: `GABARITO: alternativa D
...
{ id: 1303, explicacao: `GABARITO: alternativa A
...
{ id: 1304, explicacao: `GABARITO: alternativa C
...
{ id: 1305, explicacao: `GABARITO: alternativa B
...
{ id: 1306, explicacao: `GABARITO: alternativa E
...
{ id: 1307, explicacao: `GABARITO: alternativa A
...
{ id: 1308, explicacao: `GABARITO: alternativa D
...
{ id: 1309, explicacao: `GABARITO: alternativa A
...
{ id: 1310, explicacao: `GABARITO: alternativa B
...
{ id: 1311, explicacao: `GABARITO: alternativa B
...
{ id: 1312, explicacao: `GABARITO: alternativa A
...
{ id: 1313, explicacao: `GABARITO: alternativa E
...
BIZU DE PROVA:
Essa questão troca os rótulos das definições (física vira patrimonial, moral vira física) — sempre releia a definição e confirme com qual das modalidades do art. 7º ela realmente corresponde (hoje são 6, já contando a violência vicária acrescentada pela Lei 15.384/2026).` },

{ id: 1314, explicacao: `GABARITO: CERTO
...
{ id: 1315, explicacao: `GABARITO: alternativa B
...
{ id: 1316, explicacao: `GABARITO: CERTO
...
{ id: 1317, explicacao: `GABARITO: alternativa A
...
{ id: 1318, explicacao: `GABARITO: alternativa B
...
{ id: 1319, explicacao: `GABARITO: alternativa A
...
{ id: 1320, explicacao: `GABARITO: alternativa C
...
{ id: 1321, explicacao: `GABARITO: alternativa A
...
{ id: 1322, explicacao: `GABARITO: alternativa A
...
{ id: 1323, explicacao: `GABARITO: alternativa D
...
{ id: 1324, explicacao: `GABARITO: alternativa E
...
{ id: 1325, explicacao: `GABARITO: ERRADO
...
BIZU DE PROVA:
Memorize as modalidades do art. 7º — física, psicológica, sexual, patrimonial, moral e, desde a Lei 15.384/2026, a violência vicária. Qualquer outro nome ("simbólica", "institucional" etc.) não está na letra da lei.` },

{ id: 1326, explicacao: `GABARITO: alternativa D
...
{ id: 1327, explicacao: `GABARITO: ERRADO
...
{ id: 1328, explicacao: `GABARITO: alternativa A
...
{ id: 1329, explicacao: `GABARITO: alternativa E
...
{ id: 1330, explicacao: `GABARITO: alternativa C
