// SUB-LOTE 2 — Explicações pedagógicas completas para as próximas 40
// questões (id 1331-1370, todas SEM_EXPLICACAO) do assunto Lei Maria da
// Penha. Revisão jurídica final excluiu as ids 1337 e 1340 deste array
// (marcadas PROBLEMATICA/DESATUALIZADA por contrariarem o Tema Repetitivo
// 1.186/STJ — ver comentário no gerador do harness,
// scripts/gerar-harness-sublote2-explicacoes.mjs, para a documentação
// completa histórico-vs-atual); o array abaixo tem portanto 38 entradas.
// Mesmo formato obrigatório do sub-lote 1 (ver
// scripts/sublote1-lei-maria-penha-explicacoes.mjs para a especificação
// completa) e MESMAS correções de precisão jurídica já aplicadas lá desde o
// início desta rodada:
//   - nunca tratar prisão preventiva como automática: "há hipótese legal de
//     admissibilidade da prisão preventiva no art. 313, III, do CPP, para
//     garantir a execução das medidas protetivas, observados os requisitos
//     concretos do art. 312";
//   - contracepção de emergência / profilaxia de DST e AIDS é art. 9º, §3º
//     (não caput, não art. 8º) — usada aqui, inclusive, como o próprio
//     fundamento de uma questão (1361) que testa exatamente a diferença
//     entre art. 8º (prevenção) e art. 9º (assistência);
//   - "preferencialmente do sexo feminino" é art. 10-A, caput (não §1º);
//   - ressarcimento ao SUS pelos custos de atendimento à vítima (tema
//     recorrente em 3 questões deste sub-lote: 1346, 1355, 1368) é art. 9º,
//     §4º, incluído pela Lei 13.871/2019 — não é alteração legislativa
//     recente de 2025/2026 como se especulou em rodada de revisão anterior;
//     a citação foi corrigida para o número de parágrafo e a lei de
//     inclusão corretos em todas as ocorrências.

export const explicacoes = [
{ id: 1331, explicacao: `GABARITO: alternativa D
...
BIZU DE PROVA:
A Lei Maria da Penha não tem exceção etária: protege a mulher em situação de violência doméstica independentemente de sua idade ou da idade do agressor. E fique atento a sinônimos que a banca usa no lugar dos termos técnicos do art. 7º (física, psicológica, sexual, patrimonial, moral e, desde 2026, violência vicária) — "violência emocional" e "maus tratos" não são esses termos.` },

{ id: 1332, explicacao: `GABARITO: alternativa E
...
{ id: 1334, explicacao: `GABARITO: alternativa C
...
{ id: 1335, explicacao: `GABARITO: alternativa C
...
{ id: 1336, explicacao: `GABARITO: alternativa C
...
{ id: 1338, explicacao: `GABARITO: alternativa A
...
{ id: 1339, explicacao: `GABARITO: ERRADO
...
BIZU DE PROVA:
Sempre que uma questão tentar "reduzir" a violência doméstica a um único tipo de dano (só físico, só corporal), desconfie — o art. 7º reconhece hoje 6 modalidades, todas igualmente reconhecidas.` },

{ id: 1341, explicacao: `GABARITO: alternativa D
...
{ id: 1342, explicacao: `GABARITO: alternativa B
...
{ id: 1343, explicacao: `GABARITO: alternativa B
...
{ id: 1344, explicacao: `GABARITO: CERTO
...
{ id: 1345, explicacao: `GABARITO: alternativa A
...
{ id: 1346, explicacao: `GABARITO: alternativa C
...
{ id: 1347, explicacao: `GABARITO: alternativa B
...
{ id: 1348, explicacao: `GABARITO: alternativa C
...
{ id: 1349, explicacao: `GABARITO: alternativa A
...
BIZU DE PROVA:
A hipótese de afastamento por risco é ampla: vida ou qualquer dimensão da integridade da mulher (a redação atual do art. 12-C, desde 2026, inclui física, sexual, psicológica, moral e patrimonial), da mulher ou de seus dependentes — qualquer alternativa que restrinja essa amplitude a um único critério isolado está errada.` },

{ id: 1350, explicacao: `GABARITO: alternativa A
...
{ id: 1351, explicacao: `GABARITO: alternativa C
...
{ id: 1352, explicacao: `GABARITO: alternativa B
...
{ id: 1353, explicacao: `GABARITO: alternativa C
...
{ id: 1354, explicacao: `GABARITO: alternativa D
...
{ id: 1355, explicacao: `GABARITO: alternativa B
...
{ id: 1356, explicacao: `GABARITO: alternativa A
...
{ id: 1357, explicacao: `GABARITO: alternativa D
...
{ id: 1358, explicacao: `GABARITO: alternativa E
...
{ id: 1359, explicacao: `GABARITO: alternativa B
...
{ id: 1360, explicacao: `GABARITO: alternativa A
...
{ id: 1361, explicacao: `GABARITO: alternativa C
...
{ id: 1362, explicacao: `GABARITO: CERTO
...
{ id: 1363, explicacao: `GABARITO: alternativa E
...
{ id: 1364, explicacao: `GABARITO: ERRADO
...
{ id: 1365, explicacao: `GABARITO: alternativa D
...
{ id: 1366, explicacao: `GABARITO: ERRADO
...
{ id: 1367, explicacao: `GABARITO: alternativa B
...
{ id: 1368, explicacao: `GABARITO: alternativa D
...
{ id: 1369, explicacao: `GABARITO: alternativa B
...
{ id: 1370, explicacao: `GABARITO: alternativa D
