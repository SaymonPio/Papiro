#!/usr/bin/env node
// Gera supabase/aplicar_dh_lote2_teste_rollback.sql
// a partir de scripts/dh-lote2-explicacoes.mjs.
...
const OUT_PATH = 'supabase/aplicar_dh_lote2_teste_rollback.sql';
...
begin
  ...
  select 'os ids afetados sao exatamente os 50 esperados',
    (select array_agg(id order by id) from _dh2_ids_afetados) = ${idsLiteralArray};
