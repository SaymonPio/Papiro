...
const inputPath = 'C:/Users/User/.gemini/antigravity-cli/brain/2d2b6ae7-2a46-4595-b47e-5eefca5d453a/.system_generated/steps/651/output.txt';
const content = fs.readFileSync(inputPath, 'utf8');
const json = JSON.parse(content);
const match = json.result.match(/\[\s*\{[\s\S]*\}\s*\]/);
const data = JSON.parse(match[0]);

fs.writeFileSync('C:/Users/User/.gemini/antigravity-cli/brain/2d2b6ae7-2a46-4595-b47e-5eefca5d453a/scratch/dh-lote2-raw.json', JSON.stringify(data, null, 2), 'utf8');
