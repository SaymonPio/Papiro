#!/usr/bin/env node
// Valida as 12 explicações do Lote Final de Língua Portuguesa (materia_id 6)
...
const GABARITOS = {
  883: { correta: 'A', totalAlt: 5 },
  884: { correta: 'A', totalAlt: 5 },
  885: { correta: 'B', totalAlt: 5 },
  886: { correta: 'D', totalAlt: 5 },
  887: { correta: 'A', totalAlt: 5 },
  888: { correta: 'B', totalAlt: 5 },
  889: { correta: 'A', totalAlt: 4 },
  890: { correta: 'C', totalAlt: 4 },
  891: { correta: 'E', totalAlt: 5 },
  892: { correta: 'C', totalAlt: 5 },
  893: { correta: 'B', totalAlt: 5 },
  894: { correta: 'E', totalAlt: 5 }
};

const LETRAS = ['A', 'B', 'C', 'D', 'E'];
let falhas = 0;

console.log(`Iniciando validação de ${explicacoes.length} explicações do Lote Final de Língua Portuguesa...`);

if (explicacoes.length !== 12) {
  console.error(`FALHA: esperado 12 explicações, encontrado ${explicacoes.length}`);
  falhas++;
}
...
if (falhas === 0) {
  console.log(`✅ SUCESSO: Todas as 12 explicações foram validadas com 100% de conformidade canônica!`);
} else {
