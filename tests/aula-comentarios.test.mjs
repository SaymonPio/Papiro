...
test("interface oferece conversa e contador acessíveis",()=>{assert.match(ui,/Comentários sobre a aula/);assert.match(ui,/maxLength=\{1000\}/);assert.match(ui,/Remover meu comentário/);});
