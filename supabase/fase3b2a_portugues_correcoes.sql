...
BEGIN
  ...
  UPDATE public.questoes
     SET enunciado = 'São palavras em que a vogal "e" é acentuada pela mesma regra, EXCETO:',
         atualizado_em = now()
   WHERE id = 679;

  -- ID 680
  UPDATE public.questoes
     SET enunciado = 'As palavras "biológicos" e "acadêmicas" são acentuadas graficamente de acordo com a mesma regra que se aplica à palavra:',
         atualizado_em = now()
   WHERE id = 680;

  -- ID 681
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que apresenta palavras que, assim como "astrofísico", são acentuadas por conta da regra das proparoxítonas.',
         atualizado_em = now()
   WHERE id = 681;

  -- ID 682
  UPDATE public.questoes
     SET enunciado = 'No trecho "E, infelizmente, são muitas as circunstâncias que dificultam o desenvolvimento integral de cada pessoa", as palavras sublinhadas classificam-se, morfológica e respectivamente, como:',
         atualizado_em = now()
   WHERE id = 682;

  -- ID 684
  UPDATE public.questoes
     SET enunciado = 'No trecho "Há de se reconhecer, contudo, que esse é um privilégio para poucos – principalmente no caso dos adolescentes, cujos relógios biológicos tendem a discordar com os horários das escolas", qual é o termo ou expressão retomado(a) pela palavra "cujos"?',
         atualizado_em = now()
   WHERE id = 684;

  -- ID 685
  UPDATE public.questoes
     SET enunciado = 'Analise as seguintes assertivas sobre processos de formação de palavras:
...
Quais estão corretas?',
  ...
  -- ID 686
  UPDATE public.questoes
     SET enunciado = 'Sobre a palavra "indivíduos", analise as assertivas a seguir:
...
Quais estão corretas?',
  ...
  -- ID 687
  UPDATE public.questoes
     SET enunciado = 'As palavras indicadas a seguir podem apresentar uma vogal epentética (acréscimo de uma vogal entre consoantes na pronúncia), EXCETO:',
         atualizado_em = now()
   WHERE id = 687;

  -- ID 690
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que apresenta uma palavra corretamente escrita com "sc".',
         atualizado_em = now()
   WHERE id = 690;

  -- ID 691
  UPDATE public.questoes
     SET enunciado = 'Considerando o emprego do hífen, qual das palavras a seguir está grafada corretamente?',
         atualizado_em = now()
   WHERE id = 691;

  -- ID 692
  UPDATE public.questoes
     SET enunciado = '"Essa mentalidade justificaria até desrespeitos aos direitos básicos de alguns, se isso viesse a beneficiar um grupo maior". A forma verbal "justificaria" está flexionada no __________, em referência a fatos __________. Assinale a alternativa que preenche, correta e respectivamente, as lacunas do trecho acima.',
         atualizado_em = now()
   WHERE id = 692;

  -- ID 693
  UPDATE public.questoes
     SET enunciado = 'No trecho "Fatores como sobrepeso e obesidade estavam relacionados a aumentos [...] no risco de sintomas depressivos", a expressão "estavam relacionados" é um(a):',
         atualizado_em = now()
   WHERE id = 693;

  -- ID 744
  UPDATE public.questoes
     SET enunciado = 'Sobre determinados vocábulos da Língua Portuguesa, avalie as assertivas a seguir:
...
Quais estão corretas?',
  ...
  -- ID 745
  UPDATE public.questoes
     SET enunciado = 'Analise as assertivas a respeito da acentuação gráfica:
...
Quais estão corretas?',
  ...
  -- ID 746
  UPDATE public.questoes
     SET enunciado = 'Analise as assertivas a seguir a respeito das regras de acentuação e sinais diacríticos:
...
A ordem correta de preenchimento dos parênteses, de cima para baixo, é:',
  ...
  -- ID 747
  UPDATE public.questoes
     SET enunciado = 'Sobre as regras de acentuação gráfica na Língua Portuguesa, analise as assertivas que seguem:
...
Quais estão corretas?',
  ...
  -- ID 748
  UPDATE public.questoes
     SET enunciado = 'Em relação à palavra "rádio", assinale a alternativa correta quanto à sua acentuação gráfica.',
         atualizado_em = now()
   WHERE id = 748;

  -- ID 749
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que indica a palavra primitiva da qual a palavra "sintomático" se originou.',
         atualizado_em = now()
   WHERE id = 749;

  -- ID 750
  UPDATE public.questoes
     SET enunciado = 'Em relação aos diferentes empregos e valores da palavra "o", avalie as seguintes assertivas:
...
Quais estão corretas?',
  ...
  -- ID 752
  UPDATE public.questoes
     SET enunciado = 'O adjetivo "incrédulos" está flexionado em:',
         atualizado_em = now()
   WHERE id = 752;

  -- ID 753
  UPDATE public.questoes
     SET enunciado = 'Qual dos vocábulos abaixo tem em sua estrutura um prefixo?',
         atualizado_em = now()
   WHERE id = 753;

  -- ID 754
  UPDATE public.questoes
     SET enunciado = 'Considere os processos de formação e elementos mórficos das palavras:
...
Quais estão corretas?',
  ...
  -- ID 755
  UPDATE public.questoes
     SET enunciado = 'A palavra "vestibulando" é formada por:',
         atualizado_em = now()
   WHERE id = 755;

  -- ID 756
  UPDATE public.questoes
     SET enunciado = 'Analise as assertivas a seguir a respeito da estrutura fonológica das palavras:
...
Quais estão corretas?',
  ...
  -- ID 757
  UPDATE public.questoes
     SET enunciado = 'Em Língua Portuguesa, comumente duas letras representam um único som (dígrafo). Entre os vocábulos abaixo, assinale a alternativa que indica uma palavra em que tal fenômeno linguístico NÃO se evidencia.',
         atualizado_em = now()
   WHERE id = 757;

  -- ID 762
  UPDATE public.questoes
     SET enunciado = 'De acordo com as regras do Acordo Ortográfico (Decreto nº 6.583/2008), assinale a alternativa na qual o uso do hífen está INCORRETO.',
         atualizado_em = now()
   WHERE id = 762;

  -- ID 763
  UPDATE public.questoes
     SET enunciado = 'Considere a oração: "ao investir nesses novos formatos de capacitação, as empresas têm a oportunidade de melhorar a produtividade". Caso o verbo "ter" fosse conjugado no futuro do presente do indicativo, ele assumiria a forma:',
         atualizado_em = now()
   WHERE id = 763;

  -- ID 765
  UPDATE public.questoes
     SET enunciado = 'Caso no fragmento "Muitas vezes, as pessoas sequer percebem que estão sendo vítimas de violência, então como elas poderiam denunciar?" os verbos "percebem" e "estão" fossem corretamente flexionados no pretérito perfeito do indicativo, eles assumiriam, respectivamente, as formas:',
         atualizado_em = now()
   WHERE id = 765;

  -- ID 766
  UPDATE public.questoes
     SET enunciado = 'Considere a frase: "Às vezes, o controle vem disfarçado de cuidado". Caso a expressão "o controle" fosse substituída por sua forma plural e o verbo fosse conjugado na terceira pessoa do plural do futuro do presente, a frase assumiria a seguinte forma:',
         atualizado_em = now()
   WHERE id = 766;

  -- ID 767
  UPDATE public.questoes
     SET enunciado = 'No trecho "eu fracassaria diante dos meus pais", o verbo "fracassaria" está conjugado no:',
         atualizado_em = now()
   WHERE id = 767;

  -- ID 784
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que indica a correta classificação do advérbio sublinhado no trecho a seguir: "talvez avistar um ou outro condômino".',
         atualizado_em = now()
   WHERE id = 784;

  -- ID 785
  UPDATE public.questoes
     SET enunciado = 'A alternativa que apresenta a correta separação silábica é:',
         atualizado_em = now()
   WHERE id = 785;

  -- ID 786
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que apresenta uma palavra escrita corretamente, incluindo a acentuação, caso haja.',
         atualizado_em = now()
   WHERE id = 786;

  -- ID 806
  UPDATE public.questoes
     SET enunciado = 'Considerando a palavra "intragável", analise as assertivas a seguir:
...
Quais estão corretas?',
  ...
  -- ID 807
  UPDATE public.questoes
     SET enunciado = 'São palavras primitivas:
...
Quais estão corretas?',
  ...
  -- ID 808
  UPDATE public.questoes
     SET enunciado = 'Em qual das seguintes palavras há ocorrência de hiato?',
         atualizado_em = now()
   WHERE id = 808;

  -- ID 809
  UPDATE public.questoes
     SET enunciado = '"Autoexplicação" é uma palavra não hifenizada, assim como a palavra:',
         atualizado_em = now()
   WHERE id = 809;

  -- ID 811
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que apresenta a correta reescrita do trecho a seguir no futuro do presente do indicativo: "Os dizeres castigavam seu ideal ansioso de coletividade".',
         atualizado_em = now()
   WHERE id = 811;

  -- ID 872
  UPDATE public.questoes
     SET enunciado = 'Sobre as seguintes palavras, analise as assertivas:
...
Quais estão corretas?',
  ...
  -- ID 873
  UPDATE public.questoes
     SET enunciado = 'Observando o fragmento "total já registrado para a série histórica que soma latrocínios e feminicídios", no que tange aos vocábulos acentuados, pode-se afirmar que:',
         atualizado_em = now()
   WHERE id = 873;

  -- ID 874
  UPDATE public.questoes
     SET enunciado = 'Qual das seguintes palavras se constitui em vocábulo da Língua Portuguesa se retirado o acento gráfico?',
         atualizado_em = now()
   WHERE id = 874;

  -- ID 875
  UPDATE public.questoes
     SET enunciado = 'Dentre as palavras abaixo, qual delas, ao ser retirado o acento gráfico, NÃO continuaria a fazer parte da Língua Portuguesa?',
         atualizado_em = now()
   WHERE id = 875;

  -- ID 877
  UPDATE public.questoes
     SET enunciado = 'Quantos artigos (incluindo as contrações com preposições) estão presentes no trecho a seguir:
...
"O artigo 98 do Estatuto da Criança e do Adolescente regula a aplicação das medidas de proteção, salientando que são aplicáveis sempre que os direitos reconhecidos na mencionada lei forem ameaçados ou violados."',
  ...
  -- ID 878
  UPDATE public.questoes
     SET enunciado = 'No fragmento "Embora não estejamos satisfeitos e já assumamos o compromisso de perseguir novos recordes de redução na criminalidade", o adjetivo "novos" informa que:',
         atualizado_em = now()
   WHERE id = 878;

  -- ID 880
  UPDATE public.questoes
     SET enunciado = 'Considere as seguintes afirmações sobre processos de formação de palavras:
...
Quais estão corretas?',
  ...
  -- ID 881
  UPDATE public.questoes
     SET enunciado = 'A palavra "matéria-prima" é palavra composta por justaposição sem elementos de ligação, formando uma unidade de significado próprio. Assinale a alternativa em que ocorra o mesmo caso.',
         atualizado_em = now()
   WHERE id = 881;

  -- ID 882
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que indica o significado conferido pelo prefixo in- à palavra "inimputabilidade".',
         atualizado_em = now()
   WHERE id = 882;

  -- ID 883
  UPDATE public.questoes
     SET enunciado = 'No trecho "Nada disso seria possível, porém, sem abnegação dos nossos homens e mulheres, operadores de ponta da Brigada Militar, da Polícia Civil, do Corpo de Bombeiros Militar...", assinale a alternativa cujo vocábulo NÃO possui desinência de número.',
         atualizado_em = now()
   WHERE id = 883;

  -- ID 884
  UPDATE public.questoes
     SET enunciado = 'Sobre a palavra "enfraquecidos", é correto afirmar que:',
         atualizado_em = now()
   WHERE id = 884;

  -- ID 885
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa em que ambas as palavras sejam paroxítonas.',
         atualizado_em = now()
   WHERE id = 885;

  -- ID 886
  UPDATE public.questoes
     SET enunciado = 'No trecho "Nada disso seria possível, porém, sem abnegação dos nossos homens e mulheres, operadores de ponta da Brigada Militar...", assinale a alternativa cuja palavra tem o mesmo número de letras e de fonemas.',
         atualizado_em = now()
   WHERE id = 886;

  -- ID 887
  UPDATE public.questoes
     SET enunciado = 'Sobre o vocábulo "simultaneamente", pode-se dizer que:',
         atualizado_em = now()
   WHERE id = 887;

  -- ID 890
  UPDATE public.questoes
     SET enunciado = 'A palavra "semiliberdade" é grafada sem hífen. Assinale a alternativa que indica palavra na qual o hífen tenha sido suprimido INCORRETAMENTE, gerando grafia errada do vocábulo.',
         atualizado_em = now()
   WHERE id = 890;

  -- ID 893
  UPDATE public.questoes
     SET enunciado = 'Analise as assertivas a respeito da palavra "Trabalhando" e assinale V, se verdadeiras, ou F, se falsas:
...
A ordem correta de preenchimento dos parênteses, de cima para baixo, é:',
  ...
  SELECT q.id, h.value as hash_esperado,
    ...
    FROM json_each_text(v_hashes_questoes) h
    JOIN public.questoes q ON q.id = h.key::integer
   WHERE q.id NOT IN (679, 680, 681, 682, 684, 685, 686, 687, 690, 691, 692, 693, 744, 745, 746, 747, 748, 749, 750, 752, 753, 754, 755, 756, 757, 762, 763, 765, 766, 767, 784, 785, 786, 806, 807, 808, 809, 811, 872, 873, 874, 875, 877, 878, 880, 881, 882, 883, 884, 885, 886, 887, 890, 893)
  ...
  IF EXISTS (
    SELECT 1
      FROM public.questoes
     WHERE id IN (679, 680, 681, 682, 684, 685, 686, 687, 690, 691, 692, 693, 744, 745, 746, 747, 748, 749, 750, 752, 753, 754, 755, 756, 757, 762, 763, 765, 766, 767, 784, 785, 786, 806, 807, 808, 809, 811, 872, 873, 874, 875, 877, 878, 880, 881, 882, 883, 884, 885, 886, 887, 890, 893)
  ...
  IF (SELECT count(*) FROM public.questoes WHERE id IN (679, 680, 681, 682, 684, 685, 686, 687, 690, 691, 692, 693, 744, 745, 746, 747, 748, 749, 750, 752, 753, 754, 755, 756, 757, 762, 763, 765, 766, 767, 784, 785, 786, 806, 807, 808, 809, 811, 872, 873, 874, 875, 877, 878, 880, 881, 882, 883, 884, 885, 886, 887, 890, 893) AND position('\n' in enunciado) > 0) > 0 THEN
