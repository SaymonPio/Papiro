-- ATUALIZACAO DO ESCOPO FINAL — unidade "Garantias Constitucionais e
-- Remedios Constitucionais" (BM RS) — curadoria completa Fase 9,
...
--
-- ROLLBACK-TESTADO em
-- atualizar_escopo_artigos_esperados_dgf_u2_final_teste_rollback.sql
-- (preparado nesta mesma rodada; execucao contra LIVE fica para uma fase
-- de rollback-test dedicada, nao esta).
