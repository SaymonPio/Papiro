...
-- banco. Ver saneamento_taxonomia_q84.sql para a aplicacao real
-- (termina em COMMIT).
...
begin
  ...
  raise notice 'tudo_ok = true — Q84 reclassificada para assunto_id=36 com exatamente 1 vinculo na unidade Proposicoes e conectivos (total 5: 74,84,87,313,314), Q80/Q309 e unidade da ordem 88 intocadas.';
end $$;
