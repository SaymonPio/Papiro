-- Aplicacao REAL do saneamento documental da Q351 (Direitos Humanos e
-- Cidadania, assunto_id=99, "Tratados de Direitos Humanos com força de
-- Emenda Constitucional"), validado pelo harness
-- supabase/saneamento_explicacao_q351_teste_rollback.sql (aprovado, sem
-- nenhuma excecao levantada, antes de rodar este arquivo).
--
