...
--
-- Diferenca deste arquivo para o harness de teste: termina em COMMIT, e
-- cada precondicao/pos-condicao usa RAISE EXCEPTION (nao apenas
-- relatorio booleano) — qualquer divergencia aborta a transacao inteira
-- antes de confirmar.
--
...
-- inalterados nas pos-condicoes. NAO cria nenhum vinculo pedagogico —
-- Q89 permanece SEM vinculo apos este saneamento. A curadoria final da
-- ordem 85 (Tabela-verdade) permanece pendente, a ser feita como
-- operacao separada.
