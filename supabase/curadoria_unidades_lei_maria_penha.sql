...
begin
  ...
  update public.unidades_pedagogicas set
    ...
    escopo='Lei 11.340/2006, arts. 1º a 7º: finalidade, direitos, configuração da violência doméstica e familiar e suas formas. Não antecipar assistência, atendimento policial, procedimentos ou medidas protetivas.',
  ...
  values
    (v_conteudo_id,'Prevenção e assistência à mulher',2,
     'Lei 11.340/2006, arts. 8º a 9º: medidas integradas de prevenção e assistência à mulher em situação de violência doméstica e familiar. Não ensinar atendimento policial nem medidas protetivas.',
     array['art. 8º','art. 8º-A','art. 9º']::text[],true),
    (v_conteudo_id,'Atendimento policial e providências imediatas',3,
     'Lei 11.340/2006, arts. 10 a 12-D: atendimento pela autoridade policial, inquirição, providências, pedido da ofendida, afastamento emergencial e monitoração eletrônica. Não avançar para competência, processo judicial ou medidas protetivas dos arts. 18 e seguintes.',
    ...
    (v_conteudo_id,'Procedimentos e medidas protetivas de urgência',4,
     'Lei 11.340/2006, arts. 13 a 24-A: disposições processuais, Juizados, competência, retratação, vedações, sigilo, concessão e espécies de medidas protetivas e crime de descumprimento. Não ensinar atuação do Ministério Público, equipe multidisciplinar ou disposições finais.',
    ...
    (v_conteudo_id,'Rede de justiça, equipe multidisciplinar e disposições finais',5,
     'Lei 11.340/2006, arts. 25 a 46: Ministério Público, assistência judiciária, equipe multidisciplinar, disposições transitórias e finais e alterações legislativas promovidas pela lei.',
