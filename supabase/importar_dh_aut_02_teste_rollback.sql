-- TESTE DE ROLLBACK do Lote DH-AUT-02 de Direitos Humanos e Cidadania — 33
-- questoes AUTORAL_PAPIRO + 165 alternativas + 33 vinculos (cc77,78,79,80,81).
--
-- Mirror exato de supabase/importar_dh_aut_02.sql, substituindo os
...
-- Precondicoes.
insert into _relatorio select 'staging_total_33', (select count(*) from _lote_questoes) = 33, (select count(*) from _lote_questoes)::text;
...
insert into _relatorio select 'staging_cc77_7', (select count(*) from _lote_questoes where cc_id=77) = 7, (select count(*) from _lote_questoes where cc_id=77)::text;
insert into _relatorio select 'staging_cc78_7', (select count(*) from _lote_questoes where cc_id=78) = 7, (select count(*) from _lote_questoes where cc_id=78)::text;
insert into _relatorio select 'staging_cc79_7', (select count(*) from _lote_questoes where cc_id=79) = 7, (select count(*) from _lote_questoes where cc_id=79)::text;
insert into _relatorio select 'staging_cc80_7', (select count(*) from _lote_questoes where cc_id=80) = 7, (select count(*) from _lote_questoes where cc_id=80)::text;
insert into _relatorio select 'staging_cc81_5', (select count(*) from _lote_questoes where cc_id=81) = 5, (select count(*) from _lote_questoes where cc_id=81)::text;

insert into _relatorio select 'snapshot_cc77_uteis_3', (select cc77_uteis from _snapshot_antes) = 3, (select cc77_uteis from _snapshot_antes)::text;
insert into _relatorio select 'snapshot_cc78_uteis_3', (select cc78_uteis from _snapshot_antes) = 3, (select cc78_uteis from _snapshot_antes)::text;
insert into _relatorio select 'snapshot_cc79_uteis_3', (select cc79_uteis from _snapshot_antes) = 3, (select cc79_uteis from _snapshot_antes)::text;
insert into _relatorio select 'snapshot_cc80_uteis_3', (select cc80_uteis from _snapshot_antes) = 3, (select cc80_uteis from _snapshot_antes)::text;
insert into _relatorio select 'snapshot_cc81_uteis_5', (select cc81_uteis from _snapshot_antes) = 5, (select cc81_uteis from _snapshot_antes)::text;
...
insert into _relatorio select 'pos_questoes_novas_33',
  (select count(*) from public.questoes where id in (select questao_id from _mapa_ids)) = 33,
...
insert into _relatorio select 'pos_alternativas_165',
  (select count(*) from public.alternativas where questao_id in (select questao_id from _mapa_ids)) = 165,
...
insert into _relatorio select 'pos_dificuldade_7_16_10',
  (select count(*) from public.questoes where id in (select questao_id from _mapa_ids) and dificuldade='facil') = 7
  and (select count(*) from public.questoes where id in (select questao_id from _mapa_ids) and dificuldade='media') = 16
  and (select count(*) from public.questoes where id in (select questao_id from _mapa_ids) and dificuldade='dificil') = 10,
...
insert into _relatorio select 'pos_gabarito_A7_B7_C6_D7_E6',
  (select count(*) from public.alternativas a join _mapa_ids m on a.questao_id=m.questao_id where a.correta and a.ordem=1) = 7
  and (select count(*) from public.alternativas a join _mapa_ids m on a.questao_id=m.questao_id where a.correta and a.ordem=2) = 7
  and (select count(*) from public.alternativas a join _mapa_ids m on a.questao_id=m.questao_id where a.correta and a.ordem=3) = 6
  and (select count(*) from public.alternativas a join _mapa_ids m on a.questao_id=m.questao_id where a.correta and a.ordem=4) = 7
  and (select count(*) from public.alternativas a join _mapa_ids m on a.questao_id=m.questao_id where a.correta and a.ordem=5) = 6,
...
insert into _relatorio select 'pos_vinculos_novos_33',
  (select count(*) from public.questao_unidades_pedagogicas where questao_id in (select questao_id from _mapa_ids)) = 33,
...
insert into _relatorio select 'pos_cc77_uteis_10',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=77) = 10,
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=77)::text;
insert into _relatorio select 'pos_cc78_uteis_10',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=78) = 10,
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=78)::text;
insert into _relatorio select 'pos_cc79_uteis_10',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=79) = 10,
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=79)::text;
insert into _relatorio select 'pos_cc80_uteis_10',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=80) = 10,
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=80)::text;
insert into _relatorio select 'pos_cc81_uteis_10',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=81) = 10,
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id where up.curso_conteudo_id=81)::text;

insert into _relatorio select 'pos_real_inalterado',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id join public.questoes q on q.id=qup.questao_id where up.curso_conteudo_id=77 and coalesce(lower(q.banca),'') not like '%papiro%') = (select cc77_real from _snapshot_antes)
  and (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id join public.questoes q on q.id=qup.questao_id where up.curso_conteudo_id=78 and coalesce(lower(q.banca),'') not like '%papiro%') = (select cc78_real from _snapshot_antes)
  and (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id join public.questoes q on q.id=qup.questao_id where up.curso_conteudo_id=79 and coalesce(lower(q.banca),'') not like '%papiro%') = (select cc79_real from _snapshot_antes)
  and (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id join public.questoes q on q.id=qup.questao_id where up.curso_conteudo_id=80 and coalesce(lower(q.banca),'') not like '%papiro%') = (select cc80_real from _snapshot_antes)
  and (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id=qup.unidade_pedagogica_id join public.questoes q on q.id=qup.questao_id where up.curso_conteudo_id=81 and coalesce(lower(q.banca),'') not like '%papiro%') = (select cc81_real from _snapshot_antes),
  'ok';

insert into _relatorio select 'pos_dh_uteis_delta_33',
  (select count(distinct qup.questao_id) from public.questao_unidades_pedagogicas qup join public.unidades_pedagogicas up on up.id = qup.unidade_pedagogica_id join public.curso_conteudos cc on cc.id = up.curso_conteudo_id join public.assuntos a on a.id = cc.assunto_id where a.materia_id = 11) = (select dh_uteis from _snapshot_antes) + 33,
...
insert into _relatorio select 'pos_total_questoes_delta_33', (select count(*) from public.questoes) = (select total_questoes from _snapshot_antes) + 33, (select count(*) from public.questoes)::text;

insert into _relatorio select 'pos_total_alternativas_delta_165', (select count(*) from public.alternativas) = (select total_alternativas from _snapshot_antes) + 165, (select count(*) from public.alternativas)::text;
insert into _relatorio select 'pos_total_vinculos_delta_33', (select count(*) from public.questao_unidades_pedagogicas) = (select total_vinculos from _snapshot_antes) + 33, (select count(*) from public.questao_unidades_pedagogicas)::text;
