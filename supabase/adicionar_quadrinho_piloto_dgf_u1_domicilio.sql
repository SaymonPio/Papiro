-- ADICIONAR QUADRINHO PILOTO — U1 DGF / INVIOLABILIDADE DO DOMICILIO (PATCH REAL)
--
...
--
-- Protecao contra reexecucao: aborta se o hash mudou, se ja existe algum
-- quadrinho_didatico, se o UUID fixo ja existe, se a contagem de componentes
-- divergiu ou se o conceito alvo mudou de posicao/vizinho.
--
-- ROLLBACK-TESTADO em adicionar_quadrinho_piloto_dgf_u1_domicilio_teste_rollback.sql
-- (execucao contra LIVE em fase propria; este arquivo NAO foi executado).
