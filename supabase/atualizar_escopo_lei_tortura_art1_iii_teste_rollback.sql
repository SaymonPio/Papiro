-- TESTE DE ROLLBACK — ATUALIZACAO DE ESCOPO (fluxo completo OLD -> TARGET
-- -> REVERT -> OLD_FINAL -> ROLLBACK; NAO aplica nada permanente; ver
-- atualizar_escopo_lei_tortura_art1_iii.sql para o apply real) — unidade "Lei de Tortura" (BM RS), incorporando
...
begin
  ...
  join _snapshot_old t on t.id = up.id
  where up.id = '392fd9fe-a3d2-4062-b912-0a299b414429'::uuid;
