...
-- banco. Ver saneamento_taxonomia_q287.sql para a aplicacao real
-- (termina em COMMIT).
...
begin
  ...
  raise notice 'tudo_ok = true — Q287 reclassificada para assunto_id=35 com exatamente 1 vinculo na unidade Negacao de proposicoes (total 8: 77,81,86,88,287,311,312,337), Q83/Q288 e unidade da ordem 89 intocadas.';
end $$;
