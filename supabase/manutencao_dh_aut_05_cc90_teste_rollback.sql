-- Teste de rollback do pacote supabase/manutencao_dh_aut_05_cc90.sql
-- (correcao do campo explicacao de Q147/Q148/Q149, DH-AUT-05 / cc90).
--
...
-- de row_count, poscondicoes com checagem de hash) seja byte-identica
-- a que sera efetivamente aplicada — eliminando risco de divergencia
-- por retranscricao manual.
--
-- Ao final da execucao deste arquivo, o banco LIVE deve permanecer
-- exatamente no estado anterior (hashes antigos preservados), pois
-- toda a transacao e desfeita pelo ROLLBACK.
