...
BEGIN
  ...
  UPDATE public.questoes
     SET enunciado = 'Considerando a ortografia das palavras em Língua Portuguesa, assinale a alternativa que preenche, correta e respectivamente, as lacunas pontilhadas nas seguintes palavras retiradas do texto: cora...em – ameni...ar – fa...cínio.',
         atualizado_em = now()
   WHERE id = 66;

  -- ID 70: Enunciado autossuficiente com trechos de crase transcritos
  UPDATE public.questoes
     SET enunciado = 'Considerando o emprego do acento indicativo de crase, assinale a alternativa que preenche, correta e respectivamente, as lacunas nos seguintes trechos do texto-base:
...
3. "...começou _____ percorrer o caminho..."',
  ...
  UPDATE public.questoes
     SET enunciado = 'Considerando o emprego do acento indicativo de crase na norma-padrão, assinale a alternativa que preenche, correta e respectivamente, as lacunas nos trechos a seguir:
...
5. "...resistência _____ mudanças..."',
  ...
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa cujos vocábulos estão todos grafados de forma correta segundo a norma ortográfica vigente da Língua Portuguesa:',
         atualizado_em = now()
   WHERE id = 119;

  -- ID 120: Enunciado autossuficiente de regência e pronomes relativos
  UPDATE public.questoes
     SET enunciado = 'Considerando o emprego dos pronomes relativos e as regras de regência da norma-padrão, assinale a alternativa que preenche, correta e respectivamente, as lacunas nos trechos a seguir:
...
3. "...o autor _____ obra foi citada..."',
  ...
  UPDATE public.questoes
     SET enunciado = 'Avalie as afirmações a seguir sobre o valor semântico e as relações de equivalência de conectivos na Língua Portuguesa:
...
Quais estão corretas?',
  ...
  UPDATE public.questoes
     SET enunciado = 'Considerando a norma ortográfica vigente da Língua Portuguesa, assinale a alternativa que preenche, correta e respectivamente, as lacunas nas seguintes palavras: de...empenho – e...igente – e...gotamento – visuali...ado.',
         atualizado_em = now()
   WHERE id = 321;

  -- ID 324: Enunciado de coesão referencial autossuficiente
  UPDATE public.questoes
     SET enunciado = 'Com relação ao emprego de recursos de coesão referencial e pronominal, analise as assertivas a seguir:
...
Quais estão corretas?',
  ...
  UPDATE public.questoes
     SET enunciado = 'Considerando o emprego do acento indicativo de crase segundo a norma-padrão, assinale a alternativa que preenche, correta e respectivamente, as lacunas nos seguintes trechos:
...
3. "...somadas _____ bombas manuais..."',
  ...
  UPDATE public.questoes
     SET enunciado = 'Considerando a ortografia das palavras em Língua Portuguesa, assinale a alternativa que preenche, correta e respectivamente, as lacunas pontilhadas nas seguintes palavras: dei...ar – extin...ão – utili...ar.',
         atualizado_em = now()
   WHERE id = 329;

  -- ID 330: Higiene de OCR e linha única limpa (e...tremidades)
  UPDATE public.questoes
     SET enunciado = 'Considerando o vocábulo "e...tremidades", verifica-se que se trata de um ______________, cuja grafia correta se dá com o preenchimento da lacuna pontilhada com a letra ______ e que apresenta como sinônimo contextual adequado o termo ______________. Assinale a alternativa que preenche, correta e respectivamente, as lacunas do trecho acima.',
         atualizado_em = now()
   WHERE id = 330;

  -- ID 333: Enunciado de coesão referencial limpo e autossuficiente
  UPDATE public.questoes
     SET enunciado = 'Considerando as relações de coesão referencial no texto sobre a evolução dos equipamentos de combate a incêndio, analise as assertivas a seguir:
...
Quais estão corretas?',
  ...
  UPDATE public.questoes
     SET enunciado = 'Assinale a alternativa que indica uma conjunção que NÃO substitui adequadamente a conjunção coordenativa adversativa "mas", por introduzir valor semântico distinto e causar alteração de sentido no período:',
         atualizado_em = now()
   WHERE id = 334;
